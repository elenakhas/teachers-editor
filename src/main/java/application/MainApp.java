...
public class MainApp extends Application {
    ...
    public void start(Stage mainStage) {
        ...
        this.mainStage.setTitle("English Teacher's Text Editor");

        try {
            // Load root layout from fxml
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("application/Layouts/RootLayout.fxml"));
    ...
    public void showTextProApp() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("Layouts/TextAppLayout.fxml"));

            HBox textProPage = (HBox) loader.load();
            mainLayout.setCenter(textProPage);
