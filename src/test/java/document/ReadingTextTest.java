...
public class ReadingTextTest {
    ...
    public void testInterpretFleshKincaid() throws IOException {
        ...
        String interpretation = textKET.interpretFleshKincaid(textKET.getFleschKincaid());
        ...
        String interpret = textTOEFL.interpretFleshKincaid(textTOEFL.getFleschKincaid());
        assertEquals("Check the interpretation matches the complexity",
